...
150.times do 
    Transaction.create(user: michael, category: categories.sample, price: rand(0.00...100.00).round(2), date_of_transaction: Date.parse("2020/#{rand(01..8)}/#{rand(1..20)}"), description: Faker::Company.name)
end
